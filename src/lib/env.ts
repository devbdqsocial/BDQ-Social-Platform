...
const schema = z.object({
  ...
  WHATSAPP_PROVIDER: z.enum(["cloud", "interakt", "openwa"]).optional(),
  ...
  WHATSAPP_TEMPLATE_WAITLIST: z.string().optional(),
  ...
  OPENWA_TIMEOUT_MS: z.string().optional(),
  OPENWA_SEND_TICKET_QR: z.string().optional(),
  OPENWA_CAMPAIGN_THROTTLE_MS: z.string().optional(),
  OPENWA_TEST_TO: z.string().optional(),

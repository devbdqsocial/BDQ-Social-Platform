...
export const ENTRY_TYPES: EntryType[] = ["GATE", "QUEUE_LANE", "SECURITY_CHECK", "SCAN_POINT", "BAG_CHECK", "WELCOME_ZONE"];
...
const ENTRY_SIZE: Record<EntryType, [number, number]> = {
  GATE: [12, 6], QUEUE_LANE: [4, 20], SECURITY_CHECK: [10, 10], SCAN_POINT: [4, 4], BAG_CHECK: [8, 8], WELCOME_ZONE: [20, 15],
};
...
export const ENTRY_HEX: Record<EntryType, string> = {
  GATE: "#01065B", QUEUE_LANE: "#A7A6EC", SECURITY_CHECK: "#475569", SCAN_POINT: "#868EFF", BAG_CHECK: "#6C75F5", WELCOME_ZONE: "#3FA66A",
};

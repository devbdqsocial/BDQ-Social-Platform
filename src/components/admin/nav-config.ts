...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { label: "Venue", icon: Map, items: [
    { label: "Map Library", href: "/admin/venue/maps", section: "map" },
  ...
  { label: "Artists", icon: Music, items: [
    { label: "Roster", href: "/admin/artists", section: "artists" },
    { label: "Add Artist", href: "/admin/artists/new", section: "artists" },
  ]},
  ...
  { label: "Finance", icon: IndianRupee, items: [
    ...
    { label: "Expenses", href: "/admin/finance/expenses", section: "finance" },
    { label: "Budgets", href: "/admin/finance/budgets", section: "finance" },
    { label: "Payments", href: "/admin/finance/payments", section: "finance" },
    { label: "Settlements", href: "/admin/finance/settlements", section: "finance" },
  ]},
  ...
  { label: "Analytics", icon: BarChart3, items: [
    ...
    { label: "Funnel & Cohort", href: "/admin/analytics/funnel", section: "analytics" },
    { label: "Sales Timing", href: "/admin/analytics/sales", section: "analytics" },
    { label: "Marketing ROI", href: "/admin/analytics/marketing", section: "analytics" },
    { label: "Products", href: "/admin/analytics/products", section: "analytics" },
    { label: "Attendance", href: "/admin/analytics/attendance", section: "analytics" },
    { label: "Payment Failures", href: "/admin/analytics/failures", section: "analytics" },
    { label: "Vendor Scorecard", href: "/admin/analytics/vendors", section: "analytics" },

...
consistency. The archived design reference at `reference/bdq/rpacomunicacion.com` is treated as visual
...
| [animation-audit.md](animation-audit.md) | Visual/source audit of the BDQ reference motion system and BDQ animation upgrades. |
...
The BDQ reference animation pass includes video and sampled frames:

- `artifacts/bdq-animation-audit/video/bdq-reference-motion-desktop-full.webm`
- `artifacts/bdq-animation-audit/video-frames-full/`
- `artifacts/bdq-animation-audit/reference-motion-video-observations-full.json`
